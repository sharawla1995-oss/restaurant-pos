...
if(!html.includes(`beta29-retail-functional-finalization.js?v=${version}`))fail('Beta29 runtime not loaded with current version');ok('Beta29 runtime loaded');
...
console.log('Beta29 functional finalization regression gate passed.');
