...
const beta36Dynamic=['beta36-offline-v2.js','permissions-v2-ui.js','shared-business-core-v1.js','beta54-shared-core-ui.js','purchasing-attachments-v1.js','printing-v2.js','landed-cost-posting-v1.js','commerce-orders-v2-ui.js','reports-v2-ui.js','finance-b2b-ui.js','service-v1-ui.js','warehouse-v1-ui.js','membership-v1-ui.js','logistics-v1-ui.js','retail-variants-startup-hotfix.js','beta47-performance-sync-hotfix.js','beta49-takeover-activation-safety.js','owner-acceptance-lazy-loader-v47.js'];
const ownerLazyDynamic=['owner-acceptance-registry-v3.js','owner-acceptance-network-lab.js','owner-acceptance-e2e-v3.js','owner-acceptance-profile-packs-v3.js','owner-acceptance-retail-coverage-v53.js','owner-acceptance-shared-core-v54.js','owner-acceptance-purchasing-attachments-v54.js','owner-acceptance-advanced-v4.js','owner-acceptance-recovery-permissions-v5.js','owner-acceptance-ui-v47.js'];
...
const versionConstantFiles=['beta47-performance-sync-hotfix.js','beta49-takeover-activation-safety.js','owner-diagnostics.js','shared-business-core-v1.js','beta54-shared-core-ui.js',...ownerLazyDynamic];
for(const file of versionConstantFiles){let src=fs.readFileSync(p(file),'utf8');src=src.replace(/const VERSION='[^']+';/,`const VERSION='${version}';`);fs.writeFileSync(p(file),src,'utf8')}
...
console.log(`Version sync OK: ${version} (${channel}) — Beta54 Shared Business Core / Purchasing Attachments / Runtime Acceptance synchronized`);
