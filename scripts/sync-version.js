...
const versionConstantFiles=['beta47-performance-sync-hotfix.js','owner-diagnostics.js',...ownerLazyDynamic];
...
console.log(`Version sync OK: ${version} (${channel}) — Beta48 acceptance harness / local-first runtime validation wiring synchronized`);
