...
const versionConstantFiles=['beta47-performance-sync-hotfix.js','beta49-takeover-activation-safety.js','owner-diagnostics.js',...ownerLazyDynamic];
...
console.log(`Version sync OK: ${version} (${channel}) — Beta53 acceptance coverage Stage 2 / Retail variants + purchasing synchronized`);
