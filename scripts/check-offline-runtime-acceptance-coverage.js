...
const coverage={
 executable_runtime:['retail.offline-sale-sync','retail.lost-ack-idempotency','offline.order-status-runtime-e2e','offline.expense-runtime-e2e','offline.return-runtime-e2e'],
 ...
 declared_matrix_not_e2e:['offline_customer'],
