...
for(const t of ["id:'offline.customer-create-runtime-e2e'","id:'offline.delivery-driver-runtime-e2e'","id:'offline.delivery-economic-runtime-e2e'",'delivery_payment_events','delivery_cash_custody_amount','economic replay=stable'])has(customerDeliveryE2E,t);
...
const coverage={
 executable_runtime:['retail.offline-sale-sync','retail.lost-ack-idempotency','offline.order-status-runtime-e2e','offline.expense-runtime-e2e','offline.return-runtime-e2e','offline.customer-create-runtime-e2e','offline.delivery-driver-runtime-e2e','offline.delivery-economic-runtime-e2e'],
 ...
 known_gap:['offline customer create+dependent-address chain not yet executable','offline customer update/address edit-delete not yet executable','offline delivery payment-method change remains online-only']
};
