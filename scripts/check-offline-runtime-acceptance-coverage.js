...
const declared=['offline_return','offline_expense','offline_customer','offline_order_status'];
...
const coverage={
 executable_runtime:['retail.offline-sale-sync','retail.lost-ack-idempotency'],
 executable_online_business_semantics:['beta55.delivery-settlement-shift-cash'],
 source_contract_only:['offline_order_status routing/binding/replay guards'],
 declared_matrix_not_e2e:['offline_return','offline_expense','offline_customer','offline_order_status'],
