...
if(version!=='10.5.4-beta.45')throw new Error(`Beta45 Self-Test expected 10.5.4-beta.45, got ${version}`);
...
if(!src.includes(`const VERSION='${version}'`))throw new Error('Beta Self-Test version marker is not synchronized to Beta45 final version.');
if(!index.includes(`beta-self-test.js?v=${version}`))throw new Error('Beta Self-Test is not wired into the final Beta45 shell.');
if(!sw.includes(`./beta-self-test.js?v=${version}`))throw new Error('Beta Self-Test is not cached by the final Beta45 service worker.');
...
console.log(`Beta Self-Test final profile-aware read-only gate OK: ${version}`);
