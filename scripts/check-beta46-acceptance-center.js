...
const loader=read('beta36-integration-loader.js'),registry=read('owner-acceptance-registry-v3.js'),lab=read('owner-acceptance-network-lab.js'),mainLab=read('beta46-acceptance-network-main.js'),e2e=read('owner-acceptance-e2e-v3.js'),packs=read('owner-acceptance-profile-packs-v3.js'),preload=read('preload.js'),main44=read('main-beta44.js');
...
for(const t of ['owner-acceptance-registry-v3.js','owner-acceptance-network-lab.js','owner-diagnostics-universal-v2.js','owner-acceptance-e2e-v3.js','owner-acceptance-profile-packs-v3.js'])need(loader,t);
...
for(const src of [registry,lab,mainLab,e2e,packs]){no(src,'SH-0005','production support code SH-0005');no(src,'SH-0006','production support code SH-0006');no(src,'3e405b6f-feba-4d5c-a4bf-bebb77f2d5d7','production business id');no(src,'kzokretuuigjhxjzdlmk','production backend host')}
console.log('Beta46 Full Acceptance Center gate PASS — sandbox lock / registry / Retail + profile E2E / network faults / cleanup contracts verified');
