...
async function restV2(table,query='',opt={}){
  ...
  // RC1 practical closure: generic REST is read/delegation only.
  // Supported Offline writes use explicit accepted owners:
  // order status -> SharawlaOfflineV2Takeover.saveOrderStatus
  // customer create -> __SharawlaPV2CustomerCreate
