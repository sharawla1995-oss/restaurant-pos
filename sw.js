const CACHE='sharawla-pos-v10.5.4-beta.7';
const SHELL=['./','./index.html','./styles.css?v=10.5.4-beta.7','./update-indicators.css?v=10.5.4-beta.7','./sharawla-runtime-core.js?v=10.5.4-beta.7','./restaurant-engine.js?v=10.5.4-beta.7','./version-ui.js?v=10.5.4-beta.7','./update-ui.js?v=10.5.4-beta.7','./app.js?v=10.5.4-beta.7','./manifest.json','./icon-192.png','./icon-512.png'];
