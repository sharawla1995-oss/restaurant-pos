const CACHE='sharawla-pos-v10.5.3';
const SHELL=['./','./index.html','./styles.css?v=10.5.3','./sharawla-runtime-core.js?v=10.5.3','./restaurant-engine.js?v=10.5.3','./app.js?v=10.5.3','./manifest.json','./icon-192.png','./icon-512.png'];
