const CACHE='sharawla-pos-v10.5.4-beta.10';
const SHELL=['./','./index.html','./styles.css?v=10.5.4-beta.10','./update-indicators.css?v=10.5.4-beta.10','./sharawla-runtime-core.js?v=10.5.4-beta.10','./restaurant-engine.js?v=10.5.4-beta.10','./version-ui.js?v=10.5.4-beta.10','./update-ui.js?v=10.5.4-beta.10','./app.js?v=10.5.4-beta.10','./manifest.json','./icon-192.png','./icon-512.png'];
