const CACHE='sharawla-pos-v10.5.4-beta.8';
const SHELL=['./','./index.html','./styles.css?v=10.5.4-beta.8','./update-indicators.css?v=10.5.4-beta.8','./sharawla-runtime-core.js?v=10.5.4-beta.8','./restaurant-engine.js?v=10.5.4-beta.8','./version-ui.js?v=10.5.4-beta.8','./update-ui.js?v=10.5.4-beta.8','./app.js?v=10.5.4-beta.8','./manifest.json','./icon-192.png','./icon-512.png'];
