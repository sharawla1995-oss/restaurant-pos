...
SOURCE PREPARED (PV2-D) / DEPLOYMENT PENDING

Trusted operational Profile:
SOURCE PREPARED (PV2-B) / DEPLOYMENT PENDING

Feature-aware applicability:
SOURCE PREPARED (PV2-A/PV2-C) / DEPLOYMENT PENDING

Role-default inheritance:
SOURCE PREPARED (PV2-E) / DEPLOYMENT PENDING

Core owner coverage:
F5 ORDER LIFECYCLE SOURCE COMPLETE; OTHER OWNER FAMILIES CONTINUE

Location-aware final closure:
OPEN

Permissions V2:
SOURCE IMPLEMENTATION ADVANCED THROUGH F5; PV2-G RUNTIME ACCEPTANCE PENDING CONTROLLED BETA DEPLOYMENT
