...
const FILES=[
 ...
 ['shared-business-core-v1','shared-business-core-v1.js?v=10.5.4-beta.55'],
 ['beta54-shared-core-ui','beta54-shared-core-ui.js?v=10.5.4-beta.55'],
 ['purchasing-attachments-v1','purchasing-attachments-v1.js?v=10.5.4-beta.55'],
 ['beta55-ui-workflow-fixes','beta55-ui-workflow-fixes.js?v=10.5.4-beta.55'],
 ['beta55-ui-hardening','beta55-ui-hardening.js?v=10.5.4-beta.55'],
 ['beta55-central-warehouse-ui','beta55-central-warehouse-ui.js?v=10.5.4-beta.55'],
 ['beta55-central-warehouse-v2','beta55-central-warehouse-v2.js?v=10.5.4-beta.55'],
 ['beta55-emergency-permission-hardening','beta55-emergency-permission-hardening.js?v=10.5.4-beta.55'],
 ...
 ['orders-v2','commerce-orders-v2-ui.js?v=10.5.4-beta.55'],
 ['reports-v2','reports-v2-ui.js?v=10.5.4-beta.55'],
 ['finance-b2b','finance-b2b-ui.js?v=10.5.4-beta.55'],
 ['service-v1','service-v1-ui.js?v=10.5.4-beta.55'],
 ['warehouse-v1','warehouse-v1-ui.js?v=10.5.4-beta.55'],
 ['membership-v1','membership-v1-ui.js?v=10.5.4-beta.55'],
 ['logistics-v1','logistics-v1-ui.js?v=10.5.4-beta.55'],
 ['beta47-performance-sync-hotfix','beta47-performance-sync-hotfix.js?v=10.5.4-beta.55'],
...
async function loadAll(){
 ...
 global.__SharawlaBeta36Integration=Object.freeze({version:VERSION,files:FILES.map(x=>x[1]),loaded:true,ownerAcceptance:'lazy',takeoverSafety:'explicit-owner-only',beta51FinalOfflineAcceptanceFix:true,sharedBusinessCoreV1:true,beta54SharedCoreUI:true,purchasingAttachmentsV1:true,beta55UiWorkflowFixes:true,beta55UiHardening:true,beta55CentralWarehouse:true,beta55CentralWarehouseV2:true,beta55EmergencyPermissionHardening:true,foodRecipeRuntimeV1:true,beta55RestaurantClosureUI:true});
