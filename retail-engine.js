(function(global){
  ...
  const LEGACY_MODULES=Object.freeze(['customers','expenses','inventory','reports','returns','pos','barcode']);
  const PAGE_MODULE=Object.freeze({orders:'pos',customers:'customers',inventory:'inventory',suppliers:'inventory',purchasing:'inventory',marketSettings:'inventory',retailOffers:'pos',stockCount:'inventory',transfers:'inventory',websiteManagement:'website',expenses:'expenses',reports:'reports',returns:'returns',products:'pos',pos:'pos'});
  ...
  core.registerEngine({
    code:'retail',displayName:'Retail',phase:'core-parity-fix-pack',
  ...
  if(!document.querySelector('script[data-sharawla-retail-website-orders]')){
    const s=document.createElement('script');s.src='retail-website-pos.js?v=10.5.4-beta.19';s.defer=true;s.dataset.sharawlaRetailWebsiteOrders='1';document.head.appendChild(s);
  }
})(window);
