...
const META=Object.freeze({
 ...
 'page:stockCount':{icon:'🧮',label:'جرد الخامات',description:'جرد مخزون الخامات وترحيل الفروق',tone:'blue'},
 'page:transfers':{icon:'🔄',label:'تحويلات الخامات',description:'نقل مخزون الخامات بين الفروع',tone:'green'},
 'page:suppliers':{icon:'🚚',label:'الموردين',description:'بيانات وحسابات الموردين',tone:'violet'},
 'page:purchasing':{icon:'📥',label:'مشتريات الخامات',description:'شراء واستلام الخامات من الموردين',tone:'blue'},
