...
function printPrepReceipt(o,items){let z=document.querySelector('.print-zone');if(!z){z=document.createElement('div');z.className='print-zone';document.body.appendChild(z)}z.innerHTML=prepReceiptHTML(o,items);window.print()}
