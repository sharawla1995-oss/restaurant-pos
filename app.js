...
function point4UuidV4(){const v=String(uuid()).trim().toLowerCase();if(!/^[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/.test(v)){const e=new Error('Point 4 canonical UUIDv4 identity is unavailable');e.code='POINT4_IDENTITY_UUID_V4_REQUIRED';throw e}return v}
